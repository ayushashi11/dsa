...
// Driver Code taking input from user with prompts
int main()
{
	...
	vector<int> row_vector1(col_1, 0);
	vector<vector<int> > matrix_A(row_1, row_vector1);
	vector<int> row_vector2(col_2, 0);
	vector<vector<int> > matrix_B(row_2, row_vector2);

	cout << "\nEnter the elements of Matrix A: ";
	for (auto i = 0; i < row_1; i++)
		for (auto j = 0; j < col_1; j++)
			cin >> matrix_A[i][j];
	
	cout << "\nEnter the elements of Matrix B: ";
	for (auto i = 0; i < row_2; i++)
		for (auto j = 0; j < col_2; j++)
			cin >> matrix_B[i][j];
	print("matrix_A", matrix_A, 0, 0, row_1, col_1);
	print("matrix_B", matrix_B, 0, 0, row_2, col_2);
	vector<int> resultant_row_vector(col_2, 0);
	vector<vector<int> > resultant_matrix(
		row_1, resultant_row_vector);
	
	resultant_matrix = multiply_matrix(matrix_A, matrix_B);

	cout << "\nResultant Matrix is: ";
	print("resultant_matrix", resultant_matrix, 0, 0,
			row_1, col_2);
